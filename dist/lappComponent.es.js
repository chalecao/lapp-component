            ...
            var actions = {
                ...
                getType: function getType(props, state) {
                    if (props['textarea']) {
                        ...
                        return l('input', { onClick: actions.handleClick(props), onInput: actions.handleInput(state), onFocus: actions.handleFocus(state), onBlur: actions.handleBlur(state), 'class': 'mdl-textfield__input', type: 'text', pattern: props.pattern });
                    }
                },
