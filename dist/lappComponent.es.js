        ...
        return function (dom) {
            ...
            var actions = {
                ...
                getType: function getType(props, state) {
                    if (props['textarea']) {
                        return l('textarea', { onInput: actions.handleInput(state), onFocus: actions.handleFocus(state), onBlur: actions.handleBlur(props, state), 'class': 'mdl-textfield__input', type: 'text', rows: props.rows || 3, maxrows: props.maxrows || 3 });
                    } else {
                        return l('input', { onClick: actions.handleClick(props), onInput: actions.handleInput(state), onFocus: actions.handleFocus(state), onBlur: actions.handleBlur(props, state), 'class': 'mdl-textfield__input', type: 'text', pattern: props.pattern });
                    }
                },
...
var DatetimePicker = function DatetimePicker(_ref) {
    var props = _ref.props,
        children = _ref.children;
    return l('span', { onShow: acts.onShow(props, children), 'class': acts.getCls(props) });
};
