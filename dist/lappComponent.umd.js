                ...
                var actions = {
                    ...
                    getType: function getType(props, state) {
                        if (props['textarea']) {
                            ...
                            return lapp.l('input', { onClick: actions.handleClick(props, state), onInput: actions.handleInput(state), onFocus: actions.handleFocus(state), onBlur: actions.handleBlur(state), 'class': 'mdl-textfield__input', type: 'text', pattern: props.pattern });
                        }
                    },
